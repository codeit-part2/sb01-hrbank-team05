...
class EmployeeTest {
  ...
  void setUp() {
    ...
    Employee employee1 = new Employee("Alice", "alice@example.com", "E1", LocalDate.of(2023, 1, 1),
        EmploymentStatus.ACTIVE);
    Employee employee2 = new Employee("Bob", "bob@example.com", "E2", LocalDate.of(2023, 1, 5),
        EmploymentStatus.ACTIVE);
    Employee employee3 = new Employee("Charlie", "charlie@example.com", "E3",
        LocalDate.of(2023, 1, 7), EmploymentStatus.ACTIVE);
    Employee employee4 = new Employee("Emma", "emma@example.com", "E5", LocalDate.of(2023, 1, 13),
        EmploymentStatus.ACTIVE);
